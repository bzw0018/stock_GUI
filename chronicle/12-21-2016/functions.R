...
reading <- function(inputss) {
  ...
  if(inputss$data_prep=="Yes"){d_prep<-"DP"}else{d_prep<-""}
...
initialization<-function(input_object){
  ...
  log_imp_folds_file<-paste(c(analysis_folder,"importance/","log_imp_vars_",is_multi,"_",method_fs,"_",consolidate,"_",is_bal,"_",trg,"_",d_prep,"_",tuning,file_name),collapse = "")
  svm_imp_folds_file<-paste(c(analysis_folder,"importance/","svm_imp_vars_",is_multi,"_",method_fs,"_",consolidate,"_",is_bal,"_",trg,"_",d_prep,"_",tuning,file_name),collapse = "")
  CRT_imp_folds_file<-paste(c(analysis_folder,"importance/","CRT_imp_vars_",is_multi,"_",method_fs,"_",consolidate,"_",is_bal,"_",trg,"_",d_prep,"_",tuning,file_name),collapse = "")
  NNET_imp_folds_file<-paste(c(analysis_folder,"importance/","NNET_imp_vars_",is_multi,"_",method_fs,"_",consolidate,"_",is_bal,"_",trg,"_",d_prep,"_",tuning,file_name),collapse = "")
  tan_imp_folds_file<-paste(c(analysis_folder,"importance/","tan_imp_vars_",is_multi,"_",method_fs,"_",consolidate,"_",is_bal,"_",trg,"_",d_prep,"_",tuning,file_name),collapse = "")

  log_perf_folds_file<-paste(c(analysis_folder,"performance/","log_perf_folds_",is_multi,"_",method_fs,"_",consolidate,"_",is_bal,"_",trg,"_",d_prep,"_",tuning,file_name),collapse = "")
  svm_perf_folds_file<-paste(c(analysis_folder,"performance/","svm_perf_folds_",is_multi,"_",method_fs,"_",consolidate,"_",is_bal,"_",trg,"_",d_prep,"_",tuning,file_name),collapse = "")
  CRT_perf_folds_file<-paste(c(analysis_folder,"performance/","CRT_perf_folds_",is_multi,"_",method_fs,"_",consolidate,"_",is_bal,"_",trg,"_",d_prep,"_",tuning,file_name),collapse = "")
  NNET_perf_folds_file<-paste(c(analysis_folder,"performance/","NNET_perf_folds_",is_multi,"_",method_fs,"_",consolidate,"_",is_bal,"_",trg,"_",d_prep,"_",tuning,file_name),collapse = "")
  tan_perf_folds_file<-paste(c(analysis_folder,"performance/","tan_perf_folds_",is_multi,"_",method_fs,"_",consolidate,"_",is_bal,"_",trg,"_",d_prep,"_",tuning,file_name),collapse = "")

  Avg_log_perf_folds_file<-paste(c(analysis_folder,"performance/","Avg_log_perf_folds_","_",is_multi,"_",method_fs,"_",consolidate,"_",is_bal,"_",trg,"_",d_prep,"_",tuning,file_name),collapse = "")
  Avg_svm_perf_folds_file<-paste(c(analysis_folder,"performance/","Avg_svm_perf_folds_","_",is_multi,"_",method_fs,"_",consolidate,"_",is_bal,"_",trg,"_",d_prep,"_",tuning,file_name),collapse = "")
  Avg_CRT_perf_folds_file<-paste(c(analysis_folder,"performance/","Avg_CRT_perf_folds_","_",is_multi,"_",method_fs,"_",consolidate,"_",is_bal,"_",trg,"_",d_prep,"_",tuning,file_name),collapse = "")
  Avg_NNET_perf_folds_file<-paste(c(analysis_folder,"performance/","Avg_NNET_perf_folds_","_",is_multi,"_",method_fs,"_",consolidate,"_",is_bal,"_",trg,"_",d_prep,"_",tuning,file_name),collapse = "")
  Avg_tan_perf_folds_file<-paste(c(analysis_folder,"performance/","Avg_tan_perf_folds_","_",is_multi,"_",method_fs,"_",consolidate,"_",is_bal,"_",trg,"_",d_prep,"_",tuning,file_name),collapse = "")
...
consolidate<-function(input_object){
    ...
    if(!exists(deparse(substitute(input_object$Random_Forrest)))){consolidated<-rbind(consolidated,input_object$Random_Forrest)}
    if(!exists(deparse(substitute(input_object$Lasso)))){consolidated<-rbind(consolidated,input_object$Lasso)}
    if(!exists(deparse(substitute(input_object$FFS)))){consolidated<-rbind(consolidated,input_object$FFS)}    
    if(!exists(deparse(substitute(input_object$itself$svm)))){consolidated<-rbind(consolidated,input_object$itself$svm)}
    if(!exists(deparse(substitute(input_object$itself$log)))){consolidated<-rbind(consolidated,input_object$itself$log)}
    if(!exists(deparse(substitute(input_object$itself$crt)))){consolidated<-rbind(consolidated,input_object$itself$crt)}
    if(!exists(deparse(substitute(input_object$itself$tan)))){consolidated<-rbind(consolidated,input_object$itself$tan)}
    if(!exists(deparse(substitute(input_object$itself$nnet)))){consolidated<-rbind(consolidated,input_object$itself$nnet)}
    if(!exists(deparse(substitute(input_object$lit)))){consolidated<-rbind(consolidated,input_object$lit)}
