...
shinyUI(fluidPage(
  ...
  sidebarLayout(
    sidebarPanel(
      ...
      tags$hr(),
      selectInput(inputId="d_prep", label = "Applying Data Preparation?", choices = c("Yes","No"), selected = "No"),
      tags$hr(),
    ...
    mainPanel(
      ...
      conditionalPanel(
        ...
        # tabsetPanel( tabPanel("Results",helpText("Create demographic maps with 
