...
shinyServer(function(input,output,session){
  ...
  observe({
    ...
    input_file_format <- tools::file_ext(file1$name)
    #data_base<- rio::import(file = file1$datapath,format = input_file_format)
    
    parameters$input_file_format<-input_file_format
    #parameters$data_base<-data_base
    ...
    parameters$datapath<-file1$datapath
