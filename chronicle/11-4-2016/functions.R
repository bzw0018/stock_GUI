...
# 
# FS_Method<-input$FS_Method 
# 
#   RF_run<-input$RF_run
#   Lasso_run<-input$Lasso_run
#   FCBF_run<-input$FCBF_run  
#   itself_run<-input$itself_run 
#   lit_run<-input$lit_run 
#   conso_feat<-input$conso_feat
#   Multi_Bino<-input$Multi_Bino
#   n_folds<-input$n_folds
#   balanc_proc<-input$balanc_proc
#   B_alg<-input$B_alg
# 
# if(B_alg=="Hybrid"){
#   H_por_low<-input$H_por_low
#   H_por_high<-input$H_por_high}
# 
# parameters<-c(platform,NA_cleaning,Multi_Bino,
...
#               category_no,g1,g2,g3,g4,stk_comp,trg,conso_feat)
# 
# parameters<-as.data.frame(parameters)
# parameters[]<- lapply(parameters, as.character)
# row.names(parameters)<-c("platform","NA_cleaning","Multi_Bino",
#                          "FS_Method","Lasso_run","FCBF_run","itself_run","n_folds","balanc_proc","B_alg","H_por_low",
#                          "H_por_high","RF_run","FS_Method_1","FS_Method_2","FS_Method_3","FS_Method_4","FS_Method_5",
#                          "lit_run","category_no","g1","g2","g3","g4","stk_comp","trg","conso_feat")
# 
...
initialization<-function(input_object){
  platform<-input_object$parameters$platform
  
  Multi_Bino<-input_object$parameters$Multi_Bino
  
  FS_Method<-input_object$parameters$FS_Method
  
  Lasso_run<-input_object$parameters$Lasso_run
  FCBF_run<-input_object$parameters$FCBF_run
  itself_run<-input_object$parameters$itself_run
  n_folds<-input_object$parameters$n_folds
  n_folds<-as.numeric(n_folds)
  
  balanc_proc<-input_object$parameters$balanc_proc
  B_alg<-input_object$parameters$B_alg
  
  H_por_low<-input_object$parameters$H_por_low
  H_por_low<-as.numeric(H_por_low)
  
  H_por_high<-input_object$parameters$H_por_high
  H_por_high<-as.numeric(H_por_high)
  
  RF_run<-input_object$parameters$RF_run
  ...
  if(platform=="MAC"){root_folder<-"/Users/hamid/Dropbox/My R codes/Bin-Hamid/Stock_Prob/data/"}else{root_folder<-"C:/Users/hza0020/Dropbox/My R codes/Bin-Hamid/Stock_Prob/data/"}
  if(platform=="MAC"){analysis_folder<-"/Users/hamid/Dropbox/My R codes/Bin-Hamid/Stock_Prob/analysis/"}else{analysis_folder<-"C:/Users/hza0020/Dropbox/My R codes/Bin-Hamid/Stock_Prob/analysis/"}
  ...
  Out_put_file_name<-paste(c(stk_comp,"_",trg,"_",method_fs,"_",consolidate,"_",is_bal,"_",is_multi,".txt"),collapse = "")
  Out_put_file<-paste(c(analysis_folder,stk_comp,"_",trg,"_",method_fs,"_",consolidate,"_",is_bal,"_",is_multi,".txt"),collapse = "")
  
  prediction_data<-paste(c(root_folder,"prediction_data","_","_",method_fs,"_",consolidate,"_","_",is_multi,"_",is_bal,"_",itself_run,stk_comp,trg,"2004.csv"),collapse = "")
  old_papers_vars<-paste(c(root_folder,"vars/","vars_57.csv"),collapse = "")
  if(FS_Method_5>0){Literature_file<-old_papers_vars}
  
  log_imp_folds_file<-paste(c(analysis_folder,"importance/","log_imp_vars_","_",is_multi,"_",method_fs,"_",consolidate,"_",is_multi,"_","_",is_bal,"_",stk_comp,trg,".csv"),collapse = "")
  svm_imp_folds_file<-paste(c(analysis_folder,"importance/","svm_imp_vars_","_",is_multi,"_",method_fs,"_",consolidate,"_",is_multi,"_","_",is_bal,"_",stk_comp,trg,".csv"),collapse = "")
  CRT_imp_folds_file<-paste(c(analysis_folder,"importance/","CRT_imp_vars_","_",is_multi,"_",method_fs,"_",consolidate,"_",is_multi,"_","_",is_bal,"_",stk_comp,trg,".csv"),collapse = "")
  NNET_imp_folds_file<-paste(c(analysis_folder,"importance/","NNET_imp_vars_","_",is_multi,"_",method_fs,"_",consolidate,"_",is_multi,"_","_",is_bal,stk_comp,trg,"_",".csv"),collapse = "")
  tan_imp_folds_file<-paste(c(analysis_folder,"importance/","tan_imp_vars_","_",is_multi,"_",method_fs,"_",consolidate,"_",is_multi,"_","_",is_bal,stk_comp,trg,"_",".csv"),collapse = "")
  
  log_perf_folds_file<-paste(c(analysis_folder,"performance/","log_perf_folds_","_",is_multi,"_",method_fs,"_",consolidate,"_",is_multi,"_","_",is_bal,"_",stk_comp,trg,".csv"),collapse = "")
  svm_perf_folds_file<-paste(c(analysis_folder,"performance/","svm_perf_folds_","_",is_multi,"_",method_fs,"_",consolidate,"_",is_multi,"_","_",is_bal,"_",stk_comp,trg,".csv"),collapse = "")
  CRT_perf_folds_file<-paste(c(analysis_folder,"performance/","CRT_perf_folds_","_",is_multi,"_",method_fs,"_",consolidate,"_",is_multi,"_","_",is_bal,"_",stk_comp,trg,".csv"),collapse = "")
  NNET_perf_folds_file<-paste(c(analysis_folder,"performance/","NNET_perf_folds_","_",is_multi,"_",method_fs,"_",consolidate,"_",is_multi,"_","_",is_bal,"_",stk_comp,trg,".csv"),collapse = "")
  tan_perf_folds_file<-paste(c(analysis_folder,"performance/","tan_perf_folds_","_",is_multi,"_",method_fs,"_",consolidate,"_",is_multi,"_","_",is_bal,"_",stk_comp,trg,".csv"),collapse = "")
  
  
  Avg_log_perf_folds_file<-paste(c(analysis_folder,"performance/","Avg_log_perf_folds_","_",is_multi,"_",method_fs,"_",consolidate,"_",is_multi,"_","_",is_bal,"_",itself_run,stk_comp,trg,".csv"),collapse = "")
  Avg_svm_perf_folds_file<-paste(c(analysis_folder,"performance/","Avg_svm_perf_folds_","_",is_multi,"_",method_fs,"_",consolidate,"_",is_multi,"_","_",is_bal,"_",itself_run,stk_comp,trg,".csv"),collapse = "")
  Avg_CRT_perf_folds_file<-paste(c(analysis_folder,"performance/","Avg_CRT_perf_folds_","_",is_multi,"_",method_fs,"_",consolidate,"_",is_multi,"_","_",is_bal,"_",itself_run,stk_comp,trg,".csv"),collapse = "")
  Avg_NNET_perf_folds_file<-paste(c(analysis_folder,"performance/","Avg_NNET_perf_folds_","_",is_multi,"_",method_fs,"_",consolidate,"_",is_multi,"_","_",is_bal,"_",itself_run,stk_comp,trg,".csv"),collapse = "")
  Avg_tan_perf_folds_file<-paste(c(analysis_folder,"performance/","Avg_tan_perf_folds_","_",is_multi,"_",method_fs,"_",consolidate,"_",is_multi,"_","_",is_bal,"_",itself_run,stk_comp,trg,".csv"),collapse = "")
  
  itself_svm_Location<-paste(c(root_folder,"itself_svm_",is_bal,"_",is_multi,stk_comp,trg,"_variables.csv"),collapse = "")
  itself_log_Location<-paste(c(root_folder,"itself_log_",is_bal,"_",is_multi,stk_comp,trg,"_variables.csv"),collapse = "")
  itself_CRT_Location<-paste(c(root_folder,"itself_CRT_",is_bal,"_",is_multi,stk_comp,trg,"_variables.csv"),collapse = "")
  itself_NNET_Location<-paste(c(root_folder,"itself_NNET_",is_bal,"_",is_multi,stk_comp,trg,"_variables.csv"),collapse = "")
  itself_tan_Location<-paste(c(root_folder,"itself_tan_",is_bal,"_",is_multi,stk_comp,trg,"_variables.csv"),collapse = "")
...
data_cleaning<-function(input_object){
  ...
  library(arules); library(DMwR); library(ROSE);library(taRifx); if(input_object$parameters["platform","content"]=="MAC"){library(doMC)}
  set.seed(110)
...
Lasso_Multinomial<-function(input_object){
  if(as.numeric(input_object$parameters["Multi_Bino","content"]=="MULTINOMIAL")){
...
itself<-function(input_object){
  if(as.numeric(input_object$parameters["FS_Method_4","content"]>0)){
    if(input_object$parameters["itself_run","content"]=="N"){
      ...
      if(input_object$parameters["platform","content"]=="MAC"){
      ...
      NNET_Profile <- rfe(x, TARGET,
                          ...
                          metric="ROC",
                          trControl=trainctrl)
      if(input_object$parameters["platform","content"]=="MAC"){registerDoMC(cores = NULL)}
